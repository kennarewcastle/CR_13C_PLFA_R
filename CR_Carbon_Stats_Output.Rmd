...
```{r leaf_nested_13CO2}
leaf_CO2_mixed_mod<-lme(d13_d9~Exclusion*Tree_species,random=~1|Tree_ID/Exclusion,data=leaf_CO2,na.action=na.omit)
leaf_CO2_mixed<-Anova(leaf_CO2_mixed_mod)
anova(leaf_CO2_fixed,leaf_CO2_mixed,test="F")
```
