...
cleanDat<-cleanDat[cleanDat$Compounds.Result.Name!="12:00",]
...
cleanDat<-cleanDat[cleanDat$Compounds.Result.Name!="19:00",]
...
cleanDat<-cleanDat[cleanDat$Compounds.Result.Name!="12:0",]
cleanDat<-cleanDat[cleanDat$Compounds.Result.Name!="14:1",]
cleanDat<-cleanDat[cleanDat$Compounds.Result.Name!="17:1",]
cleanDat<-cleanDat[cleanDat$Compounds.Result.Name!="19:0",]
